...
[Doxa MCP](https://github.com/The-Doxa-Way/doxa-mcp-schema) | Christian encouragement and Bible lookup MCP server for any AI assistant; three tools grounded in the Berean Standard Bible (public domain), with a free hosted endpoint | TypeScript | - | [API](https://doxa.app/mcp/v1)
